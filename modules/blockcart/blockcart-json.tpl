...
{assign var='productAttributeId' value=$product.id_product_attribute}
	{ldelim}
		...
		"imagesmall":    "{$link->getImageLink($product.link_rewrite, $product.id_image, 'small')|addslashes|replace:'\\\'':'\''}",
		"urlthemeimg":   "{$url_theme_img}",		
		...
		"name1":          "{$product.name|html_entity_decode:2:'UTF-8'|escape|truncate:30:'...':true}",
